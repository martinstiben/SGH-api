...
public class AuthControllerTest {
    ...
    public void testRegisterSuccess() throws Exception {
        when(authService.register(any(String.class), any(String.class), any(String.class), any(Role.class), any(Integer.class))).thenReturn("Usuario registrado correctamente");
